...
const Specializations = () => {
  const specializations = [
    ...
    {
      title: "Коррекционная педагогика в начальном образовании",
      code: "44.02.05",
      description:
    ...
    },
    {
      ...
      code: "49.02.01",
      description: "Подготовка учителей физической культуры и тренеров",
      duration: "3 года 10 месяцев",
      icon: "Activity",
    },
    {
      ...
      code: "09.02.07",
      description:
        "Подготовка специалистов в области разработки и администрирования информационных систем",
      duration: "3 года 10 месяцев",
      icon: "Code",
    },
    {
      ...
      code: "35.02.03",
      description:
        "Подготовка специалистов по обработке древесины и производству изделий из дерева",
      duration: "3 года 10 месяцев",
      icon: "Trees",
    },
  ];
